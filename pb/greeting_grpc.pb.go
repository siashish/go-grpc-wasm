...
type GreetingServiceClient interface {
	Greeting(ctx context.Context, in *GreetingServiceRequest, opts ...grpc.CallOption) (*GreetingServiceReponse, error)
}
...
func (c *greetingServiceClient) Greeting(ctx context.Context, in *GreetingServiceRequest, opts ...grpc.CallOption) (*GreetingServiceReponse, error) {
	out := new(GreetingServiceReponse)
...
type GreetingServiceServer interface {
	Greeting(context.Context, *GreetingServiceRequest) (*GreetingServiceReponse, error)
...
func (UnimplementedGreetingServiceServer) Greeting(context.Context, *GreetingServiceRequest) (*GreetingServiceReponse, error) {
