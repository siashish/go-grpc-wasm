...
type GreetingServiceReponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GreetingServiceReponse) Reset() {
	*x = GreetingServiceReponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GreetingServiceReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetingServiceReponse) ProtoMessage() {}

func (x *GreetingServiceReponse) ProtoReflect() protoreflect.Message {
	mi := &file_greeting_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetingServiceReponse.ProtoReflect.Descriptor instead.
func (*GreetingServiceReponse) Descriptor() ([]byte, []int) {
	return file_greeting_proto_rawDescGZIP(), []int{1}
}

func (x *GreetingServiceReponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_greeting_proto_rawDesc = []byte{
	...
	,
...
var file_greeting_proto_goTypes = []interface{}{
	...
	(*GreetingServiceReponse)(nil), // 1: GreetingServiceReponse
}
var file_greeting_proto_depIdxs = []int32{
	0, // 0: GreetingService.Greeting:input_type -> GreetingServiceRequest
	1, // 1: GreetingService.Greeting:output_type -> GreetingServiceReponse
...
func file_greeting_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greeting_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreetingServiceReponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
